  ...
  return (
    <div className="flex h-screen flex-col bg-[#1a1a2e] text-white overflow-hidden">
      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        <div className={cn(
          "flex shrink-0 flex-col border-r border-white/[0.06] bg-[#0b1120] overflow-hidden",
          "transition-[width] duration-300 ease-in-out",
          previewMode === "split" ? "w-[420px]" : "w-0"
        )}>

          {/* Panel header — lesson index + title */}
          <div className="shrink-0 border-b border-white/[0.06] bg-[#0d1526] px-6 py-4">
            <div className="flex items-center gap-2 mb-1.5">
              <span className="inline-flex h-5 items-center rounded-md bg-[#C19562]/15 px-2 text-[10px] font-bold tracking-[0.14em] text-[#C19562] uppercase">
                Lesson {lessonIndex + 1}
              </span>
              <span className="text-[10px] text-white/20">
                of {HTML_CSS_LESSONS.length}
              </span>
            </div>
            <h2 className="text-[15px] font-bold leading-snug tracking-tight text-white/90">
              {lesson.title}
            </h2>
          </div>
          ...
          <div className="flex-1 overflow-y-auto px-6 py-6 space-y-6">
            ...
            <div>
              <div className="mb-4 flex items-center gap-2">
                ...
                <span className="text-[9px] font-bold uppercase tracking-[0.2em] text-white/25">Overview</span>
                <span className="h-px flex-1 bg-white/[0.06]" />
              </div>
            ...
            {/* Exercise */}
            {lesson.exercise && (
              <div className="rounded-2xl border border-[#C19562]/20 bg-gradient-to-b from-[#C19562]/[0.06] to-transparent">
                {/* Exercise header */}
                <div className="flex items-center gap-3 border-b border-[#C19562]/10 px-5 py-3.5">
                  <div className="flex h-7 w-7 items-center justify-center rounded-lg bg-[#C19562]/15">
                  ...
                  <div>
                    <p className="text-[11px] font-bold uppercase tracking-[0.16em] text-[#C19562]">Exercise</p>
                    <p className="text-[10px] text-white/30 mt-0.5">Apply what you learned</p>
                  </div>
                </div>
          ...
          {/* Hints + Check toolbar */}
          {lesson.exercise && (
            <div className="shrink-0 border-t border-white/[0.06] bg-[#0b1120]">
              {activePanel === "hints" && (
                <div className="border-b border-white/[0.06] bg-[#0d1526] px-5 py-4">
                  <HintPanel
              ...
              {successMsg && (
                <div className={cn(
                  "border-b border-white/[0.06] px-5 py-3 text-[12.5px] font-medium",
                  solved
              ...
              <div className="flex gap-2.5 p-4">
                <button
                  ...
                  className={cn(
                    "flex flex-1 items-center justify-center gap-2 rounded-xl px-3 py-2.5 text-[11.5px] font-semibold transition-all",
                    activePanel === "hints"
                      ? "bg-amber-500/15 text-amber-400 border border-amber-500/25 shadow-[0_0_12px_rgba(245,158,11,0.08)]"
                      : "border border-white/[0.08] bg-white/[0.04] text-white/45 hover:bg-white/[0.07] hover:text-white/75"
                  )}
                >
                  <svg className="h-3.5 w-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                ...
                <button
                  ...
                  className="flex flex-1 items-center justify-center gap-2 rounded-xl border border-emerald-500/25 bg-emerald-500/10 px-3 py-2.5 text-[11.5px] font-semibold text-emerald-400 shadow-[0_0_12px_rgba(16,185,129,0.06)] transition-all hover:bg-emerald-500/15"
                >
